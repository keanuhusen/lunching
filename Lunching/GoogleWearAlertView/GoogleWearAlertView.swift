...
class GoogleWearAlertView: UIView, UIGestureRecognizerDelegate {
    ...
    //Constants 
    let alertViewSize:CGFloat = 0.6 // 40% of presenting viewcontrollers width
    let imageViewSize:CGFloat = 0.4 // 40% of AlertViews width
    let imageViewOffsetFromCentre:CGFloat = 0.25 // Offset of image along Y axis
    let titleLabelWidth:CGFloat = 0.8 // 70% of AlertViews width
